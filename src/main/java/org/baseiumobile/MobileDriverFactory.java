...
public class MobileDriverFactory {
    ...
    public void setMobileDriver(DeviceOSType deviceOS, DriverOptions options){
        ...
        appiumCaps.setPlatform("paltformName");
        try {
            AppiumDriver appiumDriver1 = new AppiumDriver(new URI("http://127.0.0.1:4723/").toURL(),);
        ...
        switch (deviceOS){
            case ANDROID -> {
                ...
                androidOptions.setSystemPort(Integer.parseInt(options.getPort()));
                androidOptions.setUdid(options.getUdid());
